...
Answer: I think the plots from either 1.6 or 1.8 are most informative, because they show the relationship between HDI and CPI and use a line to show overall trends in the data. 1.6 with the smoothing line shows that the major trend within the data is that countries with a higher human development index have a higher perception of corruption. 1.8 makes it easier to break down this data by region.
